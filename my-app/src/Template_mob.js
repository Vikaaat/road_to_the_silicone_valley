...
class Template_mob extends React.Component {
  state = {
    countHeader: 0,
    countButton: 0,
    countBox: 0,
  ...
  moveDraggble = (e) => {
    let ofX = document.getElementById('main-root-mobile').offsetLeft
    let ofY = document.getElementById('main-root-mobile').offsetTop
  ...
  EndDraggble = (e) => {
    ...
    let ofX = document.getElementById('main-root-mobile').offsetLeft
    let ofY = document.getElementById('main-root-mobile').offsetTop
    let ofW = document.getElementById('main-root-mobile').offsetWidth
    let ofH = document.getElementById('main-root-mobile').offsetHeight
    ...
    return (
      <div /*className="App"*/>
        <div class="instrument">
          <div className="titles"><Link className="element"></Link>Поделиться</div><div className="titles"><Download className="element"></Download>Скачать</div><div className="titles"><Comments className="element"></Comments>Заметка</div><div className="titles"><ZoomIn className="element"></ZoomIn>Приблизить</div><div className="titles"><ZoomOut className="element"></ZoomOut>Отдалить</div></div>
        ...
        <main>
          ...
          <div id="main-root-mobile">
            <img class="picture" src="pngegg.png"></img>
